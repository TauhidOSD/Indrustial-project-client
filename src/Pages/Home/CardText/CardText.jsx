...
const CardText = () => {
    return (
        ...
        <h1 className="lg:text-5xl font-bold lg:mt-8  text-center md:mt-4 text-3xl animate__animated animate__shakeY">Our products</h1>
        <h1 className="animate__animated animate__bounce lg:text-2xl md:xl lg:p-10 md:p-4 ">
